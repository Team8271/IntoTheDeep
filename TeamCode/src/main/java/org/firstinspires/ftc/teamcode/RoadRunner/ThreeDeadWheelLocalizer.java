...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1909.3527697511802; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2132.5422600378865; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2702.0777809690294; // x position of the perpendicular encoder (in tick units)
    }
